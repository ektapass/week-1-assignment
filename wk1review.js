...
// const text = "Sabrina"
// const index = 4 
// console.log(`the letter at ${index} is ${text.charAt(index)}`)


// Define Unicode in a comment, and get the Unicode using charCodeAt() of the third character in Teddy
// Unicode is an international character encoding standard  that provides a unique number for
 //every letter ,digit or sumbol across languages and scripts,making almost all charaters accessible
